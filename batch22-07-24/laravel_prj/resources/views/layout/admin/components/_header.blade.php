                      ...
                      <div class="mega-menu-widgets">
                          ...
                          <i class="material-icons-outlined">question_answer</i>
                                              ...
                                              <div class="mega-menu-content">
                                                  <h5>Marketing</h5>
                                                  <p class="mb-0 f-14">In publishing and graphic design, Lorem ipsum is
                  ...
                  <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown">
                      ...
                      @if (auth()->guard('admin')->check())
                          @php
                              ...
                              $authAdmin2 = Illuminate\Support\Facades\Auth::guard('admin')->user()->admin_id;

                              $a = App\Models\Admin::where('admin_id', $authAdmin2)->with('address')->get();

                          @endphp

                          <img src="{{ asset($a[0]->address->image) }}" class="rounded-circle p-1 border"
                              width="45" height="45">
                      @else
                          <img src="{{ asset('upload/default.jpg') }}" class="rounded-circle p-1 border"
                              width="45" height="45">
                      @endif
                  ...
                  <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                      <a class="dropdown-item  gap-2 py-2" href="javascript:;">
                          <div class="text-center">
                                  ...
                                  <img src="{{ asset($a[0]->address->image) }}" class="rounded-circle p-1 shadow mb-3"
